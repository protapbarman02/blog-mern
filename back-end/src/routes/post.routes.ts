...
router.get("/:post_id/comments", postController.getCommentsByPostId.bind(postController));
router.get("/:post_id/likes", postController.getLikesByPostId.bind(postController));
